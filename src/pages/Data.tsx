...
const PARAM_LABELS: Record<string, string> = {
  ...
  tpi: 'TPI',
  tpi_res: 'Разрешение TPI',
  tpi_radii: 'Радиусы TPI',
  interpolation: 'Интерполяция ЦМР',
  inter_amp: 'Амплитуда интерп. ЦМР',
  edge_extrapolation_m: 'Экстраполяция края ЦМР, м',
  slopes_interpolation: 'Интерполяция уклонов',
  slopes_inter_amp: 'Амплитуда интерп. уклонов',
  slopes_edge_extrapolation_m: 'Экстраполяция края уклонов, м',
  aspect_interpolation: 'Интерполяция экспозиций',
  aspect_inter_amp: 'Амплитуда интерп. экспозиций',
  aspect_edge_extrapolation_m: 'Экстраполяция края экспозиций, м',
  heights: 'Высоты',
  source: 'Источник',
