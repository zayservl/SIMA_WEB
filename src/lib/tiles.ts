...
export const JOB_STEPS: Record<JobType, string[]> = {
  relief: ['Фильтрация облака точек', 'ЦМР (интерполяция)', 'ЦММ', 'Сглаживание', 'Уклоны / экспозиции', 'TPI', 'Высоты'],
  forest: ['ЦМД (CHM/ITS/DEN)', 'Сегментация крон', 'Детекция деревьев', 'Статистики по сегментам', 'Категория рубки'],
