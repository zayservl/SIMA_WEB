...
- **Доля измеренных ячеек низкая — медиана 19.9 % листа** (123 листа, 1 м/пиксель, плотность около 2 точек/м²). Остальное конвейер достраивает, и на достроенные ячейки приходится весь хвост ошибки: RMSE по всем ячейкам p95 0.495 м против 0.087 м по измеренным. Полноту растра следует контролировать отдельным приёмочным критерием — по RMSE её дефицит не виден.
